...
class net:
    ...
    def predict(self, X_test, y_test):
        ...
        model = self.model
        standard_pred = model.predict(X_test, batch_size=1, verbose=1)
        ...
        print ("Standard rmse {}".format(rmse_standard_pred)) #% (rmse_standard_pred)
        print ("MC rmse {}".format(rmse)) #% (rmse)
        print ("test_ll {}".format(test_ll)) #% (test_ll)
